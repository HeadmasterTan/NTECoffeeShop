...
* Check `Repeat Stage`, select your desired stage, and start. The tool will loop the selected stage until Urban Vitality![Urban Vitality](./docs/Energy.png) is depleted, then it will stop automatically.
	- If you want to dump your Urban Vitality![Urban Vitality](./docs/Energy.png) quickly, stage `1-1` is highly recommended.
...
![Manager's Special](./docs/ManagerScene.png)
